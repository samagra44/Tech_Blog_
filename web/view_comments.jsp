        ...
        <div class="table-responsive">
            <table class="table table-striped table-dark text-white table-bordered table-hover table-sm">
                ...
                <tr scope="row">
                    ...
                    <td><a class="btn btn-sm btn-success btn-block" href="update_comment_data.jsp?id=<%=id%>">Edit</a></td>
                    <td><a class="btn btn-sm btn-danger btn-block" href="delete_comment_data.jsp?id=<%=id%>">Delete</a></td>
                </tr>
                <% }
