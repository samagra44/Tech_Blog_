                            ...
                            <div class="card-body">
                                <form action="ForgotPassword" method="post">
                                    <div class="form-group">
                                        ...
                                        <input name="forgot_email" required type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                                    </div>
